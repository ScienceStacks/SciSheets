# Evaluation of the table MY TABLE.

    
from scisheets.core import api as api
# Uncomment the following to execute standalone
#
#_table = api.readTableFromFile('/Users/Fluids/Documents/SciSheets/mysite/user/guest/tables/scisheet_table.scish')
